...
(library Library_1
	...
	(patternDef "1822752" (originalName "1822752")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2 8.5) (pt 5.5 8.5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.5 8.5) (pt 5.5 -5.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.5 -5.2) (pt -2 -5.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2 -5.2) (pt -2 8.5) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "1822752" (originalName "1822752") (compHeader (numPins 4) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://www.phoenixcontact.com/de/produkte/1822752/pdf")
		(attr "<Component Height>" "7.85")
		(attr "<STEP Filename>" "1822752.stp")
		(attr "<STEP Offsets>" "X=-2.06;Y=8.46;Z=0")
